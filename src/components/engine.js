module.exports = (function () {
    ...
    let _STR_CIVIL_PVS = "京津晋冀蒙辽吉黑沪苏浙皖闽赣鲁豫鄂湘粤桂琼渝川贵云藏陕甘青宁新";
    ...
    let _STR_DF = "DF";
    let _STR_123 = "123";
    let _STR_NEW_ENERGY = _STR_123 + _STR_DF;
            ...
            switch (args.numberType) {
                ...
                default:
                    ...
                    if ("O" === cityCode) {
                        ...
                        // “港澳”车牌
                        let isHK_MACAO = NUM_TYPES.CIVIL === mode &&
    ...
    function _update(options) {
        ...
        if (currentIndex === undefined || currentIndex !== parseInt(currentIndex, 10)) {
