<template>
  <div class="mixed-keyboard-box">
    <number-view :numberArray="numberArray" :numberType="dyDisplayMode" :currentIndex="options.currentIndex"
      @onmodechanged="onUserSetMode" @oncellselected="onSelectedInput" />
    <div id="divider" />
    <slot></slot>
    <single-keyboard ref="singleKeyboard" :args="options" :callbacks="singleCallbacks"
    />
  </div>
</template>
